                            ...
                            <div class="bf-transaction-actions">
                                ...
                                <form method="POST" action="/transactions/delete" style="display: inline;">
                                    ...
                                    <button type="submit" class="bf-btn-icon bf-btn-icon-danger"
                                        data-confirm="Delete this transaction?" title="Delete">
                ...
                <div class="modal-body">
                    <div class="bf-form-group-dark">
                        ...
                        <div class="bf-type-toggle-group-dark">
                            <button type="button" class="bf-type-toggle-dark" data-type="expense"><i
                    ...
                    <div class="bf-form-group-dark">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control bf-input-dark" id="modal-amount" type="number" step="0.001"
                    ...
                    <div class="bf-form-row-dark">
                        <div class="bf-form-group-dark">
                            ...
                            <input class="form-control bf-input-dark" id="modal-date" type="date" name="date"
                    ...
                    <div class="bf-form-group-dark">
                        ...
                        <input class="form-control bf-input-dark" id="modal-description" type="text" name="description"
